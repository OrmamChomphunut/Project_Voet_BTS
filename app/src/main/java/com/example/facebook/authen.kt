 ...
 * [authen.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [authen.newInstance] factory method to
...
class authen : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val login :Button = view.findViewById(R.id.button_login) as Button
